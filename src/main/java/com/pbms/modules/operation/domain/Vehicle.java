 ...
 * @Author: Thái Tân Phú
 * @Date: 2026-07-03
 * @Description: Entity mapping to the [vehicles] table.
 *               Represents a customer's registered vehicle in the PBMS system.
 *               A vehicle is linked to an owner (User) and a vehicle type,
 *               and serves as the subject of Reservations and MonthlyTickets.
 * @Dependencies:
 *  - User (com.pbms.modules.identity.domain) - owner of the vehicle
 *  - VehicleType (com.pbms.modules.operation.domain) - type classification
