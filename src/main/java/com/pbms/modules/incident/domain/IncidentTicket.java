 ...
 * =========================================================================================
 * MỤC ĐÍCH:
 * Đại diện cho một bảng ghi (Record) trong Database lưu trữ thông tin về một sự cố
 * xảy ra trong quá trình đỗ xe (mất thẻ, hỏng thẻ, đỗ sai bãi, xe trong danh sách đen).
 * 
...
public class IncidentTicket extends BaseEntity {
    ...
    /**
     * Mức độ ưu tiên để hiển thị lên đầu danh sách: HIGH (Đỏ), MEDIUM (Vàng), LOW (Xanh).
     */
    ...
    /**
     * Trạng thái hiện tại của Ticket (PENDING, WAITING_CHECKOUT, RESOLVED, REJECTED, CANCELLED).
     */
    @Column(nullable = false, length = 50)
    private String status; // PENDING, WAITING_CHECKOUT, RESOLVED, REJECTED

    /**
     * Chuỗi danh sách URL ảnh minh chứng do khách hàng tải lên khi tạo sự cố (Ngăn cách bởi dấu |).
     */
    ...
    /**
     * Ghi chú các bước xử lý của nhân viên (Thường dùng format [Phase 1]... [Phase 2]...).
     */
