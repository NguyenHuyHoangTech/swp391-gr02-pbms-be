 ...
 * @Date: 2026-07-02
 * @Description: Service handling authentication, OTP verification, Google login, and password flows.
 *               Coordinates user persistence, JWT generation, and email notifications.
 * @Dependencies:
 * - UserRepository (com.pbms.modules.identity.repository.UserRepository)
 * - EmailService (com.pbms.common.service.EmailService)
 * - JwtProvider (com.pbms.common.security.JwtProvider)
 */
@Service
...
public class AuthService {
    ...
    public AuthResponse googleLogin(GoogleAuthRequest request) {
        ...
        return AuthResponse.builder()
                ...
                .linkedGoogle(true)
                .needsPasswordSetup(isNewUser || !hasPassword)
                .build();
    }
