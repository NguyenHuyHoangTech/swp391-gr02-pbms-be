 ...
 * @Date: 2026-07-02
 * @Description: Service handling staff work session lifecycle and settlement preview logic.
 *               Coordinates staff, gate, and parking session data for shift operations.
 * @Dependencies:
