 ...
 * @Date: 2026-07-02
 * @Description: Service handling user administration and account status management.
 *               Supports user search, creation, update, password reset, and WebSocket broadcasts.
 * @Dependencies:
 * - UserRepository (com.pbms.modules.identity.repository.UserRepository)
 * - EmailService (com.pbms.common.service.EmailService)
 * - SimpMessagingTemplate (org.springframework.messaging.simp.SimpMessagingTemplate)
 */
@Service
