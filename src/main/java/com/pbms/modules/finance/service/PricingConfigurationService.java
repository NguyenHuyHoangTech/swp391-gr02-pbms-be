...
public class PricingConfigurationService {
    ...
    /**
     * Lấy toàn bộ danh sách cấu hình bảng giá từ Database và chuyển thành DTO.
     */
    ...
    /**
     * Lưu hoặc cập nhật một cấu hình bảng giá.
     * Khi cập nhật, hàm này sẽ xóa toàn bộ các ca (Shifts) cũ và thay bằng các ca mới
     * (bao gồm các khối thời gian - Blocks bên trong) để đảm bảo đồng bộ hoàn toàn với Frontend.
     */
    @Transactional
    ...
    /**
     * Hàm mapper chuyển đổi từ Entity PricingPolicy (DB) sang DTO (cho Frontend).
     * Bao gồm cả việc map lồng nhau cho các Shift và Block.
     */
