 ...
 * SecurityConfig kết hợp với JwtAuthFilter, IoTAuthenticationFilter và
 * CorsConfig
...
public class SecurityConfig {
         ...
         * CORS được lấy theo CorsConfig, còn JWT và IoT authentication được xử lý bằng
         * filter riêng.
         *
         * Pseudo code:
         ...
         * 4. Cho phép các API public, auth, webhook, IoT, Swagger, WebSocket và upload
         * truy cập tự do.
         ...
         * BCryptPasswordEncoder giúp lưu password dưới dạng hash thay vì lưu password
         * gốc.
         *
         * Pseudo code:
         * 1. Tạo BCryptPasswordEncoder.
         * 2. Trả về PasswordEncoder cho Spring sử dụng trong quá trình đăng ký và đăng
         * nhập.
         */
        @Bean
